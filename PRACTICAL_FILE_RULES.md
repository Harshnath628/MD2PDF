...
In HTML used for PDF, use a div so the converter can break pages:

```html
<div class="page-break-before"></div>
```

In plain Markdown you can use a horizontal rule `---`; for a guaranteed new page, the app’s Practical File mode can insert a page-break before each practical heading.

---

## 5. Template (Copy-Paste Ready)

Replace placeholders with your data. Duplicate the “Single practical” block for each experiment.
